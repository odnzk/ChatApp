package com.study.network.impl
...
import com.study.network.impl.model.response.message.SentMessageResponse
import com.study.network.impl.model.response.message.SingleMessageResponse
import com.study.network.impl.model.response.stream.AllStreamsResponse
import com.study.network.impl.model.response.stream.StreamDetailedDto
...
import com.study.network.impl.model.response.user.UserResponse
